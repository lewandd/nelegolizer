...
Plot voxelized mesh with voxel shape: [0.2, 0.2, 0.2], [0.5, 0.5, 0.5] and const.VOXEL_MESH_SHAPE.
"""
import numpy as np
...
pv_voxels = voxelization.from_mesh(mesh, voxel_mesh_shape=np.array([0.2, 0.2, 0.2]))
plotter.subplot(0, 0)
...
pv_voxels2 = voxelization.from_mesh(mesh, voxel_mesh_shape=np.array([0.5, 0.5, 0.5]))
plotter.subplot(0, 1)
...
pv_voxels3 = voxelization.from_mesh(mesh, voxel_mesh_shape=const.VOXEL_MESH_SHAPE)
plotter.subplot(0, 2)
