...
lego_brick1 = LegoBrick(label=0, 
                        mesh_position=np.array((0,0,0)) * const.BRICK_UNIT_MESH_SHAPE, 
                        rotation=0)
lego_brick2 = LegoBrick(label=1, 
...
print("Mesh size:")
print(f"{lego_brick1.part.brick_id} mesh size: {umesh.get_resolution(lego_brick1.mesh).round(2)}")
print(f"{lego_brick2.part.brick_id} mesh size: {umesh.get_resolution(lego_brick2.mesh).round(2)}")

print("Mesh position:")
print(f"{lego_brick1.part.brick_id} mesh position: {umesh.get_position(lego_brick1.mesh).round(2)}")
print(f"{lego_brick2.part.brick_id} mesh position: {umesh.get_position(lego_brick2.mesh).round(2)}")
