"""
Test integrity of grid.from_pv_voxels and voxelization.from_grid functions.
Combination of them both should return input voxels.

Plot voxels from basic voxelization and voxels after grid.from_pv_voxels
and voxelization.from_grid functions.
"""
...
pv_voxels2 = voxelization.from_grid(voxel_grid,
                                    voxel_mesh_shape=const.VOXEL_MESH_SHAPE)
