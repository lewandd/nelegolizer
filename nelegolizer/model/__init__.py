...
#from nelegolizer.paths import 
#import pandas as pd
#from typing import Tuple
#from nelegolizer.model.io import load_model
...
#    pass
    ...
    #shape_model_map_cnn[(2,3,2)] = load_model(MODEL_232, (10,6,10))
    #shape_model_map_cnn[(2,3,1)] = load_model(MODEL_231, (10,6,5))
    #shape_model_map_cnn[(1,3,1)] = load_model(MODEL_131, (5,6,5))
    #shape_model_map_cnn[(1,1,1)] = load_model(MODEL_111, (5,2,5))
...
#    pass
    ...
    #_LABELS2_DF = pd.read_csv(LABELS2_CSV).set_index("id")
...
#    pass
    ...
    #bc_models_loader = SourceFileLoader("bc_models", BRICK_MODULES_FILE)
    ...
    #_LABELS_DF = pd.read_csv(LABELS_CSV).set_index("id")
...
def rotate_division(division, rotation):
    #TODO needs testing
    if rotation == 0:
        return division
    else:
